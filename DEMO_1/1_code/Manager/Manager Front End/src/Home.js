                    ...
                    <CardDeck>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Hello, and welcome to SmartPark! RU Ready to
                                    Park Smart? Learn all about us and how we
                                    make parking, simplified.
                                </Card.Text>
                                <Card.Link href="https://smartparkru.wordpress.com/">
                                    Blog
                                </Card.Link>
                            </Card.Body>
                        </Card>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Manager override for creating, altering,
                                    deleting, and searching for customer
                                    reservations. Send billing alerts to
                                    customer emails.
                                </Card.Text>
                                <Card.Link href="/reservations">
                                    Reservations
                                </Card.Link>
                            </Card.Body>
                        </Card>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Connect to Google Assistant with your
                                    smartphone or smart-speaker and make
                                    hands-free parking reservations.
                                </Card.Text>
                    ...
                    <CardDeck>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    View the parking garage statistics for the
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Check out our parking garage simulation!
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Change the current reservation prices and
                                    fees for your parking garage through the use
                                    of our dynamic pricing algorithm.
                                </Card.Text>

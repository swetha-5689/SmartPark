...
class EditLayout extends React.Component {
  ...
  componentDidMount() {
      axios.get("https://cryptic-depths-70075.herokuapp.com/api/floors/")
      .then(response => {
      ...
      axios.get("https://cryptic-depths-70075.herokuapp.com/api/spots/")
      .then(response => {
  ...
  getData (floorNum) {
    axios.get("https://cryptic-depths-70075.herokuapp.com/api/spots/floor/" + floorNum)
    .then(response => {
      this.setState({ data: response.data });
    })
    .catch(error => {

          ...
          {isAuthenticated && (
            <Nav className="mr-auto">
              ...
              <NavDropdown title="Edit Account" id="basic-nav-dropdown">
                ...
                <NavDropdown.Item href="/Addvehicles">Add Vehicles</NavDropdown.Item>
                <NavDropdown.Item href="/editlayout">Credit Card</NavDropdown.Item>
                <NavDropdown.Item href="/editlayout">Change Password</NavDropdown.Item>
              </NavDropdown>
